import { typedData as typedDataUtils, CallData, hash, transaction, EDAMode, } from "starknet";
import { BraavosPreset, BRAAVOS_IMPL_CLASS_HASH } from "../account/presets.js";
/**
...
export class SignerAdapter {
    ...
    async signDeployAccountTransaction(details) {
        ...
        if (det.classHash === BraavosPreset.classHash) {
            const chainIdFelt = typeof det.chainId === "string"
                ? det.chainId
